...
$last = {0=>"", 1=>"十", 2=>"百", 3=>"千", 4=>"万", 8=>"億", 12=>"兆", 16=>"京", 20=>"垓", 24=>"𥝱", 28=>"穣", 32=>"溝", 36=>"澗", 40=>"正", 44=>"載", 48=>"極", 52=>"恒河沙", 56=>"恒河沙", 60=>"那由他", 64=> "不可思議", 68=>"無量大数" }
...
class String
  def value_of(str)    
    ...
    return (10 ** $last.key(str)) if $last.values.include?(str) 
